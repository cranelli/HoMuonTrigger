...
# with command line options: cfg.py -s RAW2DIGI,RECO --conditions=POSTLS162_V1::All --filein=infile.root --no_exec
...
#    annotation = cms.untracked.string('cfg.py nevts:1'),
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('RAW2DIGI_RECO.root'),
