...
#ifndef HOMuon_TreeLoop_Struct_h
#define HOMuon_TreeLoop_Struct_h
...
class L1MuonCand{
 public:
  ...
  bool hasHO;
  bool hasMIP;
  float horeco_maxE_eta;
  float horeco_maxE_phi;
  float horeco_maxE_energy;
  bool HLT_InEvent;
  bool hasHLTRMatch;
  float hlt_minR_eta;
  float hlt_minR_phi;
...
class HOMuon_TreeLoop_Struct : public TSelector {
public :
   ...
   HOMuon_TreeLoop_Struct(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~HOMuon_TreeLoop_Struct() { }
...
#ifdef HOMuon_TreeLoop_Struct_cxx
void HOMuon_TreeLoop_Struct::Init(TTree *tree)
{
...
Bool_t HOMuon_TreeLoop_Struct::Notify()
{
...
#endif // #ifdef HOMuon_TreeLoop_Struct_cxx
