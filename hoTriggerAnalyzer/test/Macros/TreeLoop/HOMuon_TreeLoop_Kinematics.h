...
#ifndef HOMuon_TreeLoop_Kinematics_h
#define HOMuon_TreeLoop_Kinematics_h
...
class HOMuon_TreeLoop_Kinematics : public TSelector {
public :
   ...
   HOMuon_TreeLoop_Kinematics(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~HOMuon_TreeLoop_Kinematics() { }
   ...
   ClassDef(HOMuon_TreeLoop_Kinematics,0);
};

#endif

#ifdef HOMuon_TreeLoop_Kinematics_cxx
void HOMuon_TreeLoop_Kinematics::Init(TTree *tree)
{
...
Bool_t HOMuon_TreeLoop_Kinematics::Notify()
{
...
#endif // #ifdef HOMuon_TreeLoop_Kinematics_cxx
