#ifndef __HOMUON__HISTOGRAMBUILDERTWO_H__
#define __HOMUON__HISTOGRAMBUILDERTWO_H__
...
class HistogramBuilderTwo {
 ...
 public:
  ...
  void fillL1MuonPtHistograms(float pt, std::string key, double weight=1);
  void fillPtHistograms(float pt, std::string key, double weight=1);
  void fillEnergyHistograms(float energy, std::string key, double weight=1);     
  void fillEtaPhiHistograms(float eta, float phi, std::string key, double weight=1);
  void fillDeltaEtaDeltaPhiHistograms(float eta1, float eta2, 
				      float phi1, float phi2,  std::string key, double weight=1);
