...
//MakeSelector
//#include "HoMuonTrigger/hoTriggerAnalyzer/test/Macros/HOMuon_TreeLoop_Kinematics.h"
//MakeClass
//#include "HoMuonTrigger/hoTriggerAnalyzer/test/Macros/HOMuon_Loop_Kinematics.h"
...
#define MAX_EVENTS  2000000 // Default Max 1000000000  
...
void HOMuon_Kinematics(){  
  ...
  cout<< T << endl;
  //gRoot->ProcessLine(".L HOMuon_TreeLoop_FrontBack_Kinematics.C+");
  T->Process("HOMuon_TreeLoop_Kinematics.C+", "",MAX_EVENTS);



  //For MakeClass
  //gROOT->ProcessLine(".L HOMuon_Loop_Kinematics.C");
  //gROOT->ProcessLine(".L ../../plugins/HistogramBuilder.cc");
  //HOMuon_Loop_Kinematics looper;
  //looper.Loop();
  //looper.Show(16);
  //cout << "working" << endl;
};
